...
int gameID = ResultDAO.getGameID(p1Name, p2Name);
session.setAttribute("gameID", gameID);
System.out.println("p1Name : " + p1Name + " p2Name : " + p2Name);

session.setAttribute("gameID", gameID);  // modified
...
<body>
		...
		<div class="hero mb-5">
			...
			<div
				...
				<div>
					...
					<span class="badge badge-mode px-3 py-2 mb-3">PLAYER 1 ·
						PICK 3</span>

					<h1 class="text-white fw-bold mb-2">카드 선택</h1>

					<div class="text-gray-400">
						원하는 카드를 최대 <strong>3장</strong>까지 선택하세요. 선택 후 하단의 <b>다음으로</b> 버튼을
						눌러 진행합니다.
					</div>
  ...
  function syncUI(){
    ...
    selected.forEach(s=>{
      ...
      wrap.appendChild(makeInput('gameID', ${gameID}));  // modified
