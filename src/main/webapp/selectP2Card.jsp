...
<div class="container-main mx-auto py-5">
  ...
  <div class="hero mb-5">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
      <div>
        <span class="badge badge-mode px-3 py-2 mb-3">PLAYER 2 · PICK 3</span>
        <h1 class="text-white fw-bold mb-2">카드 선택</h1>
        <div class="text-gray-400">원하는 카드를 최대 <strong>3장</strong>까지 선택하세요. 선택 후 하단의 <b>싸우러가기</b> 버튼으로 전투로 이동합니다.</div>
      </div>
  ...
  <div class="sticky-progress mt-4">
    <div class="container-main mx-auto py-3 d-flex flex-wrap align-items-center justify-content-between gap-3">
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <button class="btn-next" type="button" id="btnNext" disabled onclick="goToFightPage()">
          싸우러가기
