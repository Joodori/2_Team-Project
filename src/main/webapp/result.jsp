...
<%@ page
	import="pj2.ResultDAO, pj2.ResultVO, pj2.P1CardVO, pj2.P2CardVO, pj2.GameDAO"%>
<%
...
try {
	for (pj2.P1CardVO c : p1Cards)
		p1TotalHp += c.getP1CardHp();
	for (pj2.P2CardVO c : p2Cards)
		p2TotalHp += c.getP2CardHp();
} catch (Exception e) {
	e.printStackTrace();
}
%>
...
.dead {
	background: linear-gradient(135deg, rgba(244, 63, 94, .18),
		rgba(244, 63, 94, .08));
	...
	<div class="container-main mx-auto py-5">
		...
		<div class="hero mb-5">
			<div
				...
				<div>
					...
					<div
						class="d-flex flex-wrap align-items-center gap-2 text-gray-300">
						<span class="stat-pill">P1 HP <strong
							class="ms-1 text-white"><%=p1TotalHp%></strong></span> <span
							class="stat-pill">P2 HP <strong class="ms-1 text-white"><%=p2TotalHp%></strong></span>
						<span class="stat-pill animate__animated animate__pulse animate__infinite">벌칙 <strong class="ms-1 text-white"><%=penalty%></strong></span>
					</div>
				</div>
						...
						<div class="d-flex align-items-center gap-2">
							<div class="trophy">
								<svg width="22" height="22" viewBox="0 0 24 24"
									fill="currentColor">
									<path
										d="M17 3h-2V1H9v2H7a1 1 0 0 0-1 1v3a4 4 0 0 0 3 3.87V13H7v2h10v-2h-2V10.87A4 4 0 0 0 18 7V4a1 1 0 0 0-1-1zm-8 1h6v2a2 2 0 1 1-6 0V4zM5 5H3v2a4 4 0 0 0 4 4V9a2 2 0 0 1-2-2V5zm16 0h-2v2a2 2 0 0 1-2 2v2a4 4 0 0 0 4-4V5z" /></svg>
							</div>
		...
		<div class="row g-4">
			...
			<div class="col-12 col-xl-6">
				<div class="card card-glass h-100">
					<div
						...
						<span class="stat-pill">총 HP <strong
							class="ms-1 text-white"><%=p1TotalHp%></strong></span>
					</div>
					<div class="card-body">
						<div class="row g-3">
							<%
							for (P1CardVO c : p1Cards) {
								...
								int bar = (int)((double)hp / Math.max(1, maxHp) * 100);
							%>
							<div class="col-12 col-md-6">
								<div class="card card-glass <%=isDead ? "dead" : ""%> h-100">
									<div class="card-body">
										...
										<div
											class="d-flex justify-content-between text-gray-300 small">
											<span>HP</span> <span
												class="<%=isDead ? "text-danger fw-bold" : "text-white fw-bold"%>"><%=maxHp%></span>
										</div>
										<div class="progress hp-bar mt-1 bg-dark">
											<div class="progress-bar bg-success <%=isDead ? "bg-danger" : ""%>"
												style="width:<%=bar%>%">
												<%= hp %> / <%= maxHp %></div>
										</div>
										<%
			...
			<div class="col-12 col-xl-6">
				<div class="card card-glass h-100">
					<div
						...
						<span class="stat-pill">총 HP <strong
							class="ms-1 text-white"><%=p2TotalHp%></strong></span>
					</div>
					<div class="card-body">
						<div class="row g-3">
							<%
							for (P2CardVO c : p2Cards) {
								...
								int hp = c.getP2CardHp();
								int maxHp = c.getP2CardMaxHp();  
								int bar = (int)((double)hp / Math.max(1, maxHp) * 100);
							%>
							<div class="col-12 col-md-6">
								<div class="card card-glass <%=isDead ? "dead" : ""%> h-100">
			...
			<div class="sticky-actions mt-5">
				<div
					class="container-main mx-auto py-3 d-flex flex-wrap align-items-center justify-content-end gap-3">
					<div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">벌칙!</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
					</div>
					<div class="modal-body text-dark"><%=penalty%></div>
